...
class GeneralCalibrationMeasurePercentChange < OpenStudio::Ruleset::ModelUserScript
  ...
  # human readable name
  def name
    return "General Calibration Measure Percent Change"
  end

  # human readable description
  def description
    return "This is a general purpose measure to calibrate space and space type elements with a percent change."
  end
